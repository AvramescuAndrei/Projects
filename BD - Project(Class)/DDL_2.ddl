...
CREATE SEQUENCE animale_id_animale_seq START WITH 5000 MINVALUE 5000 MAXVALUE 6999 NOCACHE ORDER;
...
BEGIN
    :new.id_animale := animale_id_animale_seq.nextval;
END;
/

CREATE SEQUENCE autovehicule_id_autovehicule START WITH 1000 MINVALUE 1000 MAXVALUE 2999 NOCACHE ORDER;
...
BEGIN
    :new.id_autovehicule := autovehicule_id_autovehicule.nextval;
END;
/
...
CREATE SEQUENCE comenzi_id_comenzi_seq START WITH 7000 MINVALUE 7000 MAXVALUE 9000 NOCACHE ORDER;
...
CREATE SEQUENCE seminte_id_seminte_seq START WITH 3000 MINVALUE 3000 MAXVALUE 4999 NOCACHE ORDER;
